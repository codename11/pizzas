...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  <head>
    ...
    <link rel="shortcut icon" href="pizza.webp" />
    <!--secure_asset(...) samo za heroku-->
    <!-- CSRF Token -->
    ...
    <link href="{{ secure_asset('css/open-iconic-bootstrap.min.css') }}" rel="stylesheet">
    ...
    <link href="{{ secure_asset('css/bootstrap-datepicker.css') }}" rel="stylesheet">
    <link href="{{ secure_asset('css/jquery.timepicker.css') }}" rel="stylesheet">

    
    <link href="{{ secure_asset('css/flaticon.css') }}" rel="stylesheet">
    <link href="{{ secure_asset('css/icomoon.css') }}" rel="stylesheet">
  ...
  <body data-spy="scroll" data-target=".ftco_navbar" data-offset="160">
  	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <li class="nav-item"><a href="#ftco-menu" class="nav-link">Menu</a></li>
        ...
        <div class="container">
          <div class="row slider-text align-items-center" data-scrollax-parent="true">
            ...
            <div class="col-md-6 col-sm-12 ftco-animate">
              ...
              <p><a href="#ftco-menu" class="btn btn-white btn-outline-white p-3 px-xl-4 py-xl-3">View Menu</a></p>
            </div>
    ...
    <section class="ftco-section" id="pricing">
    	<div class="container">
    		<div class="row justify-content-center mb-5 pb-3">
          <div class="col-md-7 heading-section ftco-animate text-center">
            <h2 class="mb-4">Newest addition to our menu</h2>
            <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
          </div>
        </div>
    	</div>
...
<script src="{{ secure_asset('js/jquery.magnific-popup.min.js') }}" defer></script>
<script src="{{ secure_asset('js/aos.js') }}" defer></script>
<script src="{{ secure_asset('js/jquery.animateNumber.min.js') }}" defer></script>
<script src="{{ secure_asset('js/bootstrap-datepicker.js') }}" defer></script>
<script src="{{ secure_asset('js/jquery.timepicker.min.js') }}" defer></script>
<script src="{{ secure_asset('js/scrollax.min.js') }}" defer></script>
